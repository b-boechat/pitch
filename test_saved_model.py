...
def print_examples(saved_model_path):
    ...
    for example in dataset.take(1):
        X_contours, X_notes, X_onsets = example[1]["X_contours"][0], example[1]["X_notes"][0], example[1]["X_onsets"][0]
        print(X_contours)
...
if __name__ == "__main__":
    ...
    print_examples("saved_models/trained.h5")