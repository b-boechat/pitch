...
def mir_evaluate_model_on_files(model, file_path, onset_threshold, frame_threshold):
        ...
        if new_full_audio_id != full_audio_id: # Start of new audio file.       
            ...
            if full_audio_id is not None:
                metrics = _evaluate_audio(
                        full_audio_id, full_audio_target_dict, full_audio_predicted_dict,
...
def _evaluate_audio(full_audio_id, target_dict, predicted_dict, onset_threshold, frame_threshold):
    ...
    metrics = {"id": full_audio_id}
    metrics.update(mir_eval.transcription.evaluate(
